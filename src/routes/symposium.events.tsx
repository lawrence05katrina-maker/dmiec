...
const EVENTS: EventInfo[] = [
  ...
  },
  {
    ...
    desc: "Showcase a working project — Software Only. Offline only.",
    venue: "Smart Classroom (EEE block)", time: "10:00 AM – 3:00 PM",
    coordinator: "Dr.Rajeesh Kumar & Mr.Crystal Anto · +91 9944840240 & +91 9894862415",
    rules: ["Each entry gets a 6x3 ft table", "Power sockets provided, bring your own extension if needed", "Judging at 2:00 PM sharp"],
  },
  {
    name: "Website Creation", category: "Technical", tag: "Solo",
    desc: "Design and build a site live, against the clock.",
    venue: "IT Lab(Admin Block)", time: "11:00 AM – 1:00 PM",
    coordinator: "Mrs.Adlin Beenu · +91 6385860688",
    rules: ["Theme announced on the spot", "2 hours, any framework", "Internet access provided"],
  },
  {
    name: "Debugging", category: "Technical", tag: "Solo",
    desc: "Find and fix bugs faster than everyone else.",
    venue: "IT Lab(EEE Block) ", time: "1:30 PM – 3:00 PM",
    coordinator: "Mr.Arun Venkatesh · +91 9994496329",
  ...
  },
  {
    ...
    venue: "IT Lab (EEE Block)", time: "2:00 PM – 3:30 PM",
    coordinator: "Mrs.Babiyola · +91 8925170341",
  ...
  },
  {
    ...
    venue: "IT Lab(Admin Block)", time: "12:00 PM – 1:00 PM",
    coordinator: "Mrs.Adlin Beenu · +91 6385860688",
  ...
  },
  {
    ...
    venue: "IT Lab(Admin Block)", time: "3:30 PM – 4:30 PM",
    coordinator: "Mrs.Bratheesha · +91 9487774660",
  ...
  },
  {
    ...
    venue: "EEE Seminar hall", time: "4:00 PM – 5:00 PM",
    coordinator: "Mrs.Babiyola Mam · +91 8925170341",
  ...
  },
  {
    ...
    venue: "Smart classroom (EEE block)", time: "5:30 PM – 6:30 PM",
    coordinator: "Mrs.Afrin Banu  · +91 9486666141",
