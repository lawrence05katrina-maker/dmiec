...
function SuccessStep({
  ...
  return (
    <div className="mt-8 sm:mt-10 space-y-5">
      ...
      <div className="relative border-2 border-[#25D366] p-6 sm:p-8 overflow-hidden bg-[#25D366]/5">
        <div className="absolute -top-16 -right-16 w-48 h-48 bg-[#25D366]/10 blur-3xl pointer-events-none" />
        <div className="relative text-center">
          <div className="inline-block px-3 py-1 bg-[#25D366] text-white text-[10px] uppercase tracking-[0.25em] font-bold mb-4">
            Join Our Community
          </div>
          <h3 className="text-xl sm:text-2xl font-black uppercase tracking-tight mb-2">
            InfoVerse<span className="text-[#FF0000]">26</span> WhatsApp Group
          </h3>
          <p className="text-sm text-white/60 leading-relaxed mb-5 max-w-md mx-auto">
            Get instant updates, connect with participants, and stay informed about event details.
          </p>

          <a
            href="https://chat.whatsapp.com/GvZeRXFowG492SX8ZUBLiV"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 bg-[#25D366] text-white text-xs sm:text-sm font-bold uppercase tracking-wide hover:brightness-110 transition-all"
          >
          ...
          <p className="text-[11px] text-white/35 mt-4 leading-relaxed">
            Stay connected with the InfoVerse26 community
          </p>
        </div>
      </div>
